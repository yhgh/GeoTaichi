...
dem.read_restart(file_number=20, file_path="Medium/Generation", particle=True, sphere=True, wall=True, servo=True, ppcontact=True, pwcontact=True, is_continue=False)
...
def consol_ss():
    ...
    dem.scene.servo[0].update_current_force(-force[0][2])
    dem.scene.servo[1].update_current_force(force[1][2])
