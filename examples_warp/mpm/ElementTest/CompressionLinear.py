...
mpm.add_body(body={
                       "Template": [{
                                       ...
                                       "ParticleStress": {
                                                              "GravityField":     False,
                                                              "InternalStress":   ti.Vector([-303000, -303000, -303000, 0., 0., 0.])
                                                         },
...
mpm.scene.velocity_boundary[0].velocity = [0, 0, -0.02]
...
mpm.scene.velocity_boundary[1].velocity = [0, 0, -0.02]
...
mpm.scene.velocity_boundary[2].velocity = [0, 0, -0.02]
...
mpm.scene.velocity_boundary[3].velocity = [0, 0, -0.02]
...
mpm.scene.velocity_boundary[4].velocity = [0, 0, 0.02]
...
mpm.scene.velocity_boundary[5].velocity = [0, 0, 0.02]
...
mpm.scene.velocity_boundary[6].velocity = [0, 0, 0.02]
...
mpm.scene.velocity_boundary[7].velocity = [0, 0, 0.02]
