...
'''p = 306000 / 0.5
mpm.scene.particle[0].traction = [p, p, 0]
mpm.scene.particle[1].traction = [-p, p, 0]
mpm.scene.particle[2].traction = [p, -p, 0]
mpm.scene.particle[3].traction = [-p, -p, 0]
mpm.scene.particle[4].traction = [p, p, -0]
mpm.scene.particle[5].traction = [-p, p, -0]
mpm.scene.particle[6].traction = [p, -p, -0]
mpm.scene.particle[7].traction = [-p, -p, -0]'''
